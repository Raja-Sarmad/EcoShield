...
export default function AboutPage() {
  return (
    <div className="bg-white overflow-hidden text-slate-900">
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative pt-8 pb-14 sm:pt-10 sm:pb-20 lg:pt-10 lg:pb-32 bg-[rgb(246,250,247)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            <motion.div 
              ...
              className="flex-1 space-y-5 lg:space-y-8 text-center lg:text-left"
            >
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 mt-6">
                {[
                  ...
                  <div key={i} className="bg-white/80 backdrop-blur-md border border-white rounded-2xl p-3 sm:p-4 min-w-[100px] sm:min-w-[120px] shadow-sm">
            ...
            >
              ...
              >
                <Image
                  ...
                  width={380}
                  height={500}
                  className="drop-shadow-[0_35px_35px_rgba(0,0,0,0.12)] object-contain w-[220px] sm:w-[300px] lg:w-[380px] h-auto"
                  priority
                />
              </motion.div>
            </motion.div>
      ...
      {/* --- MECHANISM SECTION --- */}
      <section className="py-16 sm:py-20 md:py-24 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Science Behind the Shield</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8">
            {steps.map((s, idx) => (
              <motion.div whileHover={{ y: -5 }} key={idx} className="bg-slate-50 p-6 sm:p-8 rounded-3xl shadow-sm border border-slate-100 relative group">
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 leading-tight text-center lg:text-left">
            ...
            <div className="bg-emerald-900 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 text-white relative overflow-hidden shadow-2xl">
               <div className="relative z-10">
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-medium mb-6 leading-snug">
      ...
      {/* --- COMPATIBILITY --- */}
      <section className="py-16 sm:py-20 md:py-24 bg-slate-900 text-white rounded-[2.5rem] sm:rounded-[4rem] mx-3 sm:mx-4 mb-8 sm:mb-12 shadow-2xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">One Spray, Infinite Uses</h2>
          <p className="text-slate-400 mb-10 sm:mb-16 text-sm sm:text-base">Tested on all major footwear materials.</p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            {useCases.map((u, i) => (
              <motion.div 
                ...
                key={i} 
                className="bg-slate-800/40 p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-slate-700 hover:border-emerald-500 transition-colors group"
              >
                <div className="text-3xl sm:text-5xl mb-3 sm:mb-4 bg-slate-800 w-14 h-14 sm:w-20 sm:h-20 flex items-center justify-center rounded-xl sm:rounded-2xl mx-auto group-hover:bg-slate-700 transition-colors">
                  {u.icon}
                </div>
                <h4 className="text-base sm:text-xl font-bold mb-1 sm:mb-2">{u.type}</h4>
                <p className="text-xs sm:text-sm text-slate-400">{u.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
