        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              <motion.h1 
                ...
                className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-[0.9] tracking-tight"
              >
              ...
              <motion.p 
                ...
                className="text-lg sm:text-xl md:text-2xl font-bold text-amber-700/80 italic font-serif mt-4 sm:mt-8"
              >
            ...
            <motion.p 
              ...
              className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 mb-4 sm:mb-10"
            >
            ...
            <motion.div 
              ...
              className="flex flex-col sm:flex-row gap-3 sm:gap-5 justify-center lg:justify-start w-full"
            >
              <Link 
                href="/shop" 
                className="group flex items-center justify-center gap-3 bg-emerald-600 text-white px-8 sm:px-10 py-4 sm:py-5 rounded-2xl font-bold text-base sm:text-lg shadow-2xl shadow-emerald-200 hover:bg-emerald-700 transition-all active:scale-95"
              >
                Pre-Order Now
              ...
              <Link 
                href="/gallery" 
                className="flex items-center justify-center gap-3 bg-white border-2 border-slate-200 text-slate-700 px-8 sm:px-10 py-4 sm:py-5 rounded-2xl font-bold text-base sm:text-lg hover:border-emerald-600 hover:text-emerald-600 transition-all shadow-sm"
              >
            ...
            <motion.div 
              ...
              className="flex flex-wrap items-center justify-center lg:justify-start gap-6 sm:gap-8 pt-4 sm:pt-8 opacity-60 grayscale hover:grayscale-0 transition-all"
            >
          ...
          <div className="flex-1 flex justify-center relative w-full">
            ...
            <motion.div 
              ...
              className="absolute top-4 right-4 sm:top-10 sm:right-10 md:top-20 md:right-0 bg-white/80 backdrop-blur-xl p-3 sm:p-4 rounded-2xl sm:rounded-3xl shadow-xl border border-white z-20 hidden sm:block"
            >
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="p-2 sm:p-3 bg-amber-100 rounded-xl sm:rounded-2xl">
                  <span className="text-xl sm:text-2xl font-bold text-amber-700 leading-none">0%</span>
                </div>
                <div>
                  <p className="text-[10px] uppercase font-black text-slate-400">Chemicals</p>
                  <p className="font-bold text-slate-800 text-sm sm:text-base">Bio-Based</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
               ...
               className="absolute bottom-4 left-0 sm:bottom-10 bg-white/80 backdrop-blur-xl p-3 sm:p-4 rounded-2xl sm:rounded-3xl shadow-xl border border-white z-20 hidden sm:block"
            >
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-slate-800 text-sm sm:text-base">4+ Weeks Protection</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                <Image
                  ...
                  width={500}
                  height={600}
                  className="drop-shadow-[0_50px_50px_rgba(16,185,129,0.2)] lg:scale-110 w-[220px] sm:w-[320px] md:w-[400px] lg:w-[500px] h-auto"
                  priority
                />
              </motion.div>
